...
export default function PropertyEdit({ property, onBack, onSave }: PropertyEditProps) {
  const [activeTab, setActiveTab] = useState('info');
  const [parentPropertys, setParentPropertys] = useState<any[]>([]);

  useEffect(() => {
    const fetchPropertys = async () => {
      try {
        const data = await propertiesAPI.getAll();
        setParentPropertys(data);
      } catch (err) {
        console.error('Error fetching parent propertys', err);
      }
    };
    fetchPropertys();
  }, []);
  ...
  const [mapImage, setMapImage] = useState(property.mapImage || '');
  const [isFeatured, setIsFeatured] = useState(property.isFeatured !== undefined ? property.isFeatured : true);
  const [showOnHome, setShowOnHome] = useState(property.showOnHome !== undefined ? property.showOnHome : true);
  const [metaDesc, setMetaDesc] = useState("An Khang Riverside – Bất động sản nhà phố cao cấp ven sông tại Quận 2, TP. Thủ Đức với tiện ích đẳng cấp.");
  const [displayPrice, setDisplayPrice] = useState(
    property.price ? Number(property.price).toLocaleString('vi-VN') : ''
  );
  const [displayOrder, setDisplayOrder] = useState(property.displayOrder || 1);
  ...
  const handleSaveBtn = () => {
    ...
    const updatedProperty = {
      ...property,
      title: titleRef.current?.value || property.name,
      slug: slugRef.current?.value || property.code,
      type: typeRef.current?.value || property.typeValue,
      address: addressRef.current?.value || property.location,
      status: statusRef.current?.value || property.statusValue,
      price: displayPrice ? parseFloat(displayPrice.replace(/\./g, '')) : property.price,
      area: areaRef.current?.value || property.area,
      bedrooms: bedroomsRef.current?.value || property.bedrooms,
      bathrooms: bathroomsRef.current?.value || property.bathrooms,
      direction: directionRef.current?.value || property.direction,
      description: editorRef.current?.innerHTML || property.description,
      legal: legalRef.current?.value || property.legal || '',
      propertyId: propertyIdRef.current?.value ? parseInt(propertyIdRef.current.value) : (property.propertyId || null),
        ...
        <div className="ape-card no-top-radius">
          ...
          <div className="ape-form-grid">
            <div className="ape-form-group">
              <label>Tên bất động sản <span>*</span></label>
              <div className="ape-input-wrapper">
                <input type="text" defaultValue={property.name} ref={titleRef} />
              </div>
            </div>
            ...
            <div className="ape-form-group">
              ...
              <div className="ape-input-wrapper">
                <input type="text" defaultValue={property.code} ref={slugRef} />
              </div>
            ...
            <div className="ape-form-group">
              ...
              <div className="ape-input-wrapper">
                <select defaultValue={property.typeValue || 'APARTMENT'} ref={typeRef}>
            ...
            <div className="ape-form-group">
              ...
              <div className="ape-input-wrapper ape-status-select-wrapper">
                ...
                <select defaultValue={property.statusValue || 'AVAILABLE'} ref={statusRef}>
            ...
            <div className="ape-form-group">
              ...
              <div className="ape-input-wrapper">
                ...
                <input type="text" defaultValue={property.location} className="with-left-icon" ref={addressRef} />
              </div>
            </div>
            ...
            <div className="ape-form-group">
              ...
              <div className="ape-input-wrapper">
                <input type="number" step="0.1" defaultValue={property.area} ref={areaRef} />
              </div>
            </div>
            ...
            <div className="ape-form-group">
              ...
              <div className="ape-input-wrapper">
                <input type="number" defaultValue={property.bedrooms} ref={bedroomsRef} />
              </div>
            </div>
            ...
            <div className="ape-form-group">
              ...
              <div className="ape-input-wrapper">
                <input type="number" defaultValue={property.bathrooms} ref={bathroomsRef} />
              </div>
            </div>
            ...
            <div className="ape-form-group">
              <label>Hướng</label>
              <div className="ape-input-wrapper">
                <input type="text" defaultValue={property.direction} ref={directionRef} />
              </div>
            </div>
            ...
            <div className="ape-form-group">
              <label>Pháp lý</label>
              <div className="ape-input-wrapper">
                <input type="text" placeholder="Sổ hồng, Sổ đỏ..." defaultValue={property.legal} ref={legalRef} />
              </div>
            </div>

            <div className="ape-form-group">
              <label>Bất động sản khu vực</label>
              <div className="ape-input-wrapper">
                <select defaultValue={property.propertyId || ''} ref={propertyIdRef}>
                  <option value="">-- Không thuộc bất động sản nào --</option>
                  {parentPropertys.map(p => (
            ...
            <div className="ape-form-group full-width">
              <label>Mô tả bất động sản</label>
        ...
        <div>
          ...
          <div className="ape-card">
            ...
            <div className="ape-meta-group">
              ...
              <div className="ape-input-wrapper">
                <input type="text" defaultValue={property.name || "An Khang Riverside – Nhà phố cao cấp ven sông"} />
              </div>
            </div>
